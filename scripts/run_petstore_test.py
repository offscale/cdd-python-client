...
def main():
    test_harness_dir = os.environ.get("TEST_HARNESS_DIR", os.path.expanduser("~/repos/cdd-openapi-test-harness"))
    ...
    cmd = ["uv", "run", "cdd-python", "from_openapi", "to_sdk_cli", "-i", input_path, "-o", tmp_dir]
